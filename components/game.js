...
export default function Game(props) {
  ...
  const play = async () => {
    ...
    if (response.status === 405) {
      return toast.warn('No more games available, please wait until reset.', {
        theme: 'dark',
      })
    }
    ...
    return (
      <div className={styles.mainContainer}>
        ...
        <div className={styles.disclaimer}>
          Please do not setup a bot/script, as this application is hosted for
          free as a hobby project.
        </div>
      </div>
    )
  } else {
        ...
        <div className={styles.resultsContainer}>
          <div className={styles.gameContainer}>
            <div className={styles.playerContainer}>
              ...
              <div className={lastGame.result ? styles.win : styles.loss}>
                {lastGame.username}
              </div>
            ...
            <div className={styles.playerContainer}>
              ...
              <h3 className={styles.subtitle}>Username</h3>
              <div className={lastGame.result ? styles.loss : styles.win}>
